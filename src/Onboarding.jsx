...
const steps = [
  {
    ...
    icon: <Sparkles size={48} className="text-black" strokeWidth={1} />,
    color: "bg-orange-50"
  },
  {
    ...
    icon: <LayoutGrid size={48} className="text-black" strokeWidth={1} />,
    color: "bg-blue-50"
  },
  {
    ...
    icon: <MousePointer2 size={48} className="text-black" strokeWidth={1} />,
    color: "bg-purple-50"
  },
  {
    ...
    icon: <FileText size={48} className="text-black" strokeWidth={1} />,
    color: "bg-green-50"
  },
  {
    ...
    icon: <Check size={48} className="text-black" strokeWidth={1} />,
    color: "bg-yellow-50"
  }
];
        ...
        <div className="p-10 flex flex-col items-center text-center">
          ...
          <div className="flex gap-2 mb-10">
            {steps.map((_, i) => (
              <div 
                key={i} 
                className={`h-1.5 rounded-full transition-all duration-300 ${i === currentStep ? 'w-8 bg-black' : 'w-2 bg-[#e5e5e0]'}`}
              />
            ))}
          </div>
          {}
          <div className="flex items-center justify-between w-full">
            <button 
              onClick={back}
              className={`p-3 rounded-full transition-colors ${currentStep === 0 ? 'opacity-0 pointer-events-none' : 'hover:bg-[#f4f4f0] text-[#888]'}`}
            >
              <ChevronLeft size={24} />
            </button>
            <button 
